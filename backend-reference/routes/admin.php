...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
   ...
   Route::get('home-banner/edit', [HomeBannerController::class, 'edit'])->name('home_banner.edit');
   Route::post('home-banner/update', [HomeBannerController::class, 'update'])->name('home_banner.update');
