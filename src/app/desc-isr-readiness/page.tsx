...
export const metadata = {
  title: 'Free UAE Compliance Readiness Score | CyberGOAT',
  description:
    "Upload your policy documents and get a free preliminary readiness score against Dubai's DESC ISR, the UAE's federal PDPL, and/or DESC's AI Security Policy - reviewed by a certified CyberGOAT security professional.",
};
...
const FRAMEWORKS = [
  {
    ...
    title: 'DESC ISR',
    tagline: "Dubai's information security regulation",
    domains: ['Governance', 'Information Asset Management', 'Risk Management', 'Incident Response'],
    color: 'border-[#00F0FF]/40 text-[#00F0FF]',
  },
  {
    icon: ScaleIcon,
    title: 'UAE PDPL',
    tagline: "The UAE's federal Personal Data Protection Law",
    domains: ['Lawful Basis & Consent', 'Data Subject Rights', 'Breach Notification', 'Cross-Border Transfers'],
    color: 'border-[#2F57EF]/40 text-[#2F57EF]',
  },
  {
    icon: SparklesIcon,
    title: 'AI Security Policy',
    tagline: "Dubai's security requirements for AI systems",
    domains: ['AI Risk Governance', 'Model & Data Security', 'Human Oversight', 'Third-Party AI Due Diligence'],
        ...
        <div className="container mx-auto px-6 relative z-10">
          <RevealOnScroll className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-lg sm:text-xl text-white font-medium leading-relaxed max-w-2xl mx-auto">
              Upload your organization&rsquo;s policy documents and get a free preliminary readiness score against
              Dubai&rsquo;s DESC Information Security Regulation (ISR), the UAE&rsquo;s federal Personal Data
              Protection Law (PDPL), and/or DESC&rsquo;s AI Security Policy &mdash; choose the framework(s) that
              matter to you.
            </p>
          </RevealOnScroll>
        </div>
          ...
          <div className="lg:col-span-3 space-y-10">
            <RevealOnScroll>
              ...
              <p className="text-xs text-gray-500 mb-4 -mt-2">
                Select any combination of these on the form &mdash; you only get scored on what you choose.
              </p>
              <div className="space-y-4">
                {FRAMEWORKS.map((fw) => {
                  ...
                  return (
                    <div
                      key={fw.title}
                      className={`bg-[#05080F] border rounded-3xl p-6 glass-card hover:scale-[1.01] transition-all ${fw.color}`}
                    >
                      <div className="flex items-center gap-2 mb-1 font-extrabold text-sm">
                        <Icon className="w-5 h-5" />
                        <span>{fw.title}</span>
                      </div>
                      <p className="text-xs text-gray-400 mb-3">{fw.tagline}</p>
                      <div className="flex flex-wrap gap-1.5">
                        {fw.domains.map((domain) => (
                          <span
                            key={domain}
                            className="px-2.5 py-1 rounded-full text-[10px] font-medium bg-white/5 border border-white/10 text-gray-300"
                          >
                            {domain}
                          </span>
                        ))}
            ...
            <RevealOnScroll delay={0.1}>
              ...
              <ol className="space-y-4">
                {[
                  { icon: SparklesIcon, text: 'Choose your framework(s) and upload your existing policy documents (PDF or DOCX).' },
                  { icon: ShieldCheckIcon, text: 'Our AI performs a preliminary review against the framework(s) you selected.' },
            ...
            <RevealOnScroll delay={0.15}>
              <div className="rounded-3xl border border-amber-500/30 bg-amber-500/5 p-6 space-y-2">
                ...
                <p className="text-sm text-gray-300 leading-relaxed">
                  ...
                  understanding your posture against the framework(s) you select &mdash; <strong className="text-white">not
                  a certified audit</strong>, and it does not substitute for a formal compliance certification or
