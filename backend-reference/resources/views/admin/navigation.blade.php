                ...
                <li
                    ...
                    <ul class="first-sub-menu">
                        ...
                        <li class="sidebar-second-li {{ $current_route == 'admin.system.settings' ? 'active' : '' }}">
                          ...
                          <li class="sidebar-second-li {{ $current_route == 'admin.home_banner.edit' ? 'active' : '' }}">
                            <a href="{{ route('admin.home_banner.edit') }}">{{ get_phrase('Home Banner') }}</a>
                        </li>
                          <li class="sidebar-second-li {{ $current_route == 'admin.pricing-plans' ? 'active' : '' }}">
                            <a href="{{ route('admin.pricing-plans.index') }}">{{ get_phrase('Price Plans') }}</a>
                        </li>
                          <li class="sidebar-second-li {{ $current_route == 'admin.testimonials' ? 'active' : '' }}">
                            <a href="{{ route('admin.testimonials.index') }}">{{ get_phrase('Testimonials') }}</a>
                        </li>
